...
export default async function SettingsPage() {
  ...
  return (
    <div className="p-4 md:p-8 max-w-4xl">
      <div className="mb-8">
        <h1 className="text-3xl font-bold text-ink mb-2">Ajustes del Bot</h1>
        <p className="text-ink-2">Administra la configuracion de tu chatbot y datos de negocio.</p>
      </div>

      <form action={updateSettings} className="space-y-8 bg-surface border border-line rounded-xl p-4 md:p-8">
        {/* Business Info */}
        <div className="space-y-4">
          <h2 className="text-lg font-semibold text-ink">Informacion del Negocio</h2>

          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="flex flex-col gap-2">
              <label htmlFor="businessName" className="text-sm font-medium text-ink-2">Nombre del Local / Negocio</label>
              <input
                id="businessName"
                name="businessName"
                type="text"
            ...
            <div className="flex flex-col gap-2">
              <label htmlFor="whatsappNumber" className="text-sm font-medium text-ink-2">Numero de WhatsApp (Con codigo pais)</label>
              <input
                id="whatsappNumber"
                name="whatsappNumber"
                type="text"
          ...
          <div className="flex flex-col gap-2">
            <label htmlFor="address" className="text-sm font-medium text-ink-2">Direccion</label>
            <input
              id="address"
              name="address"
              type="text"
        ...
        <div className="border-t border-line pt-8 space-y-4">
          <h2 className="text-lg font-semibold text-ink">Mensaje de Bienvenida del Bot</h2>
          <p className="text-sm text-ink-2">Este mensaje se enviara automaticamente cuando un cliente nuevo escriba por WhatsApp.</p>
          <div className="flex flex-col gap-2">
            <textarea
              id="chatbotGreeting"
              ...
              className="bg-surface border border-line rounded-lg p-3 text-sm text-ink focus:border-emerald-500 outline-none transition-colors resize-none"
            />
          </div>
        </div>
        ...
        {/* Booksy / Calendar */}
        <div className="border-t border-line pt-8 space-y-4">
          <h2 className="text-lg font-semibold text-ink">Booksy y Google Calendar</h2>

          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="flex flex-col gap-2">
              <label htmlFor="booksyProfileUrl" className="text-sm font-medium text-ink-2">URL de Perfil Booksy</label>
              <input
                id="booksyProfileUrl"
            ...
            <div className="flex flex-col gap-2">
              <label htmlFor="googleCalendarId" className="text-sm font-medium text-ink-2">Google Calendar ID</label>
              <input
                id="googleCalendarId"
        ...
        <div className="pt-4 flex items-center justify-end">
          <button
            type="submit"
            className="rounded-lg bg-emerald-500 hover:bg-emerald-400 px-8 py-3 text-sm font-bold text-white transition-colors active:scale-95"
          >
      ...
      <div className="mt-8 bg-surface border border-line rounded-xl p-4 md:p-8 space-y-4">
        <div>
          <h2 className="text-lg font-semibold text-ink">Dias Bloqueados</h2>
          <p className="text-sm text-ink-2 mt-1">Bloquea fechas especificas (vacaciones, festivos) para que el bot no ofrezca esos dias.</p>
        </div>
        <BlockedDatesManager
