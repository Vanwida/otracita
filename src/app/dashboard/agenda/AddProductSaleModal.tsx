...
//      refrescar UI.
//
// NOTA: este modal SOLO vende productos al cliente. Consumo interno y merma
// viven en /dashboard/ventas/productos (botón "Registrar consumo") — no tiene
// sentido cablearlos aquí porque no requieren cita asociada.
// -----------------------------------------------------------------------------
