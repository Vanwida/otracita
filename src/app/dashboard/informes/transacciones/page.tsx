...
// -----------------------------------------------------------------------------
// /dashboard/informes/transacciones — pestaña TRANSACCIONES (Booksy literal:
...
//
// Vive en INFORMES, no en Ventas (U-13): es el libro de lo ya cobrado, no una
// vía de cobro. Ventas quedó reducida a las 4 pestañas donde el barbero ACTÚA
// (Nueva venta · Caja · Facturas · Productos). /dashboard/ventas/transacciones
// sigue redirigiendo aquí.
//
...
export default async function InformesTransaccionesPage() {
    ...
    <AreaShell area="informes">
      <AreaContent scroll="region" maxWidth="7xl">
        <div className="mb-4 flex items-baseline justify-between">
          <p className="text-ink-2" style={{ fontSize: 'var(--text-meta)' }}>
