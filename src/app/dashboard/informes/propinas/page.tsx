...
// -----------------------------------------------------------------------------
// /dashboard/informes/propinas — pestaña PROPINAS del área Informes.
//
// Tres bloques:
...
//
// Vive en INFORMES, no en Ventas (U-13): las propinas no son una vía de cobro,
// son reparto de dinero ya entrado. Ventas quedó reducida a las 4 pestañas
// donde el barbero ACTÚA (Nueva venta · Caja · Facturas · Productos).
// /dashboard/ventas/propinas sigue redirigiendo aquí. El selector de periodo
// lo monta esta página (antes lo inyectaba el header del área Ventas).
//
...
export default async function InformesPropinasPage({ searchParams }: PageProps) {
