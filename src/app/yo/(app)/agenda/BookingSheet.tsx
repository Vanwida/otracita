...
// Slide-over para detalle + acciones sobre una cita. Móvil: pegado al
// borde inferior estilo iOS Sheet.
interface Props {
...
type Phase = 'idle' | 'charge' | 'success';
        ...
        <div className="px-5 pb-6 pt-4">
          ...
          {phase === 'success' ? (
            <div className="py-8 text-center">
              ...
              {tipCents > 0 && (
                <p className="mt-1 text-sm text-ink-2">Propina registrada</p>
              )}
            </div>
          ) : !isConfirmed ? (
