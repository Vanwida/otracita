...
// -----------------------------------------------------------------------------
// Hash del PIN del jefe (admin-lock) — scrypt nativo (Node), sin dependencia
// externa.
//
...
//   · scrypt viene en Node ≥ 10 con parámetros de coste comparables. PIN de
//     4-6 dígitos: el espacio de búsqueda es pequeño y la defensa primaria
//     es online (la ruta /api/admin-lock/unlock no expone el hash). El
//     factor "lentitud" del hash es importante para el escenario de DB-dump.
//
